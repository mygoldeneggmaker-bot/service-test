document.addEventListener("DOMContentLoaded", () => {
  ...
  const menuSearchTerms = {
    ...
    튀김: "korean fried food",
    어묵: "eomuk korean fish cake",
    라면: "ramen noodles",
  };
        ...
        img.onload = () => {
          illustrationDiv.innerHTML = `
            ...
            <div class="photographer-credit">
              Photo by <a href="${photographerUrl}?utm_source=mygoldeneggmaker_bot&utm_medium=referral" target="_blank">${photographer}</a>
