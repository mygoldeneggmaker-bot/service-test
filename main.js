...
document.addEventListener('DOMContentLoaded', () => {
    const menu = {
        korean: ["비빔밥", "김치찌개", "된장찌개", "불고기", "잡채", "순두부찌개", "제육볶음", "갈비탕", "냉면", "삼계탕", "감자탕", "해물파전", "보쌈", "족발", "닭갈비", "안동찜닭", "육개장", "설렁탕", "추어탕", "알탕", "동태찌개", "청국장", "김치볶음밥", "오징어볶음", "낙지볶음", "부대찌개", "소갈비찜", "돼지갈비찜", "아귀찜", "해물찜", "돼지불백", "순대국", "뼈해장국", "콩나물국밥", "닭곰탕", "피순대", "평양냉면", "들기름 막국수", "통닭", "수육국밥", "돌솥비빔밥", "간장게장", "양념게장", "전복죽", "꼬막비빔밥", "매운탕", "곱창전골", "대창전골", "순대볶음", "김밥", "만두", "곱창", "막창", "회", "죽", "도시락", "짜글이", "조개구이", "찜닭", "칼국수", "라면", "육회", "두부찌개", "파전", "김치전", "감자전", "석쇠불고기", "김치찜"],
        japanese: ["초밥", "라멘", "돈까스", "우동", "야끼소바", "오코노미야끼", "텐동", "가츠동", "규동", "사케동", "장어덮밥", "소바", "스키야키", "샤브샤브", "야키토리", "타코야끼", "모밀", "나베", "함박스테이크", "카레라이스", "된장라면", "마제소바", "오야코동", "부타동", "히츠마부시", "몬자야키", "가라아게", "고로케", "메밀소바", "나가사키 짬뽕", "양갈비"],
        ...
        american: ["스테이크", "햄버거", "클럽 샌드위치", "에그 베네딕트", "프렌치 토스트", "수비드 목살 스테이크", "대파 크림치즈 베이글", "브리스킷", "바베큐 플래터", "미트볼 스파게티", "오믈렛", "샥슈카", "타코", "부리또", "퀘사디아", "엔칠라다", "나초", "파히타", "칠리 콘 카르네", "과카몰리", "치미창가", "포케", "샐러드", "김피탕", "파닭"],
        latin_american: ["세비체", "로모 살타도", "아사도", "엠파나다", "페이조아다", "슈하스코", "아레파", "반데하 파이사"],
        middle_eastern: ["케밥", "후무스", "팔라펠", "타불레", "샥슈카", "피타 브레드", "무사카", "코프타"],
        dessert: ["케이크", "마카롱", "아이스크림", "빙수", "와플", "크로플", "허니브레드", "타르트", "스콘", "쿠키", "도넛", "에그타르트", "푸딩", "티라미수", "다쿠아즈", "망고 빙수", "소금빵", "맘모스빵", "슈크림빵", "단팥빵", "카스테라", "붕어빵", "호떡", "약과", "개성주악", "탕후루", "꽈배기", "핫도그", "떡볶이", "순대", "튀김", "어묵", "군고구마", "군밤", "뻥튀기", "달고나", "츄러스", "떡꼬치", "알감자", "인절미", "꿀떡", "송편", "아메리카노", "카페라떼", "바닐라라떼", "카푸치노", "스무디", "에이드", "과일주스"]
    };
