...
document.addEventListener('DOMContentLoaded', () => {
    const menu = {
        korean: ["비빔밥", "김치찌개", "된장찌개", "불고기", "잡채", "순두부찌개", "제육볶음", "갈비탕", "냉면", "삼계탕", "감자탕", "해물파전", "보쌈", "족발", "닭갈비", "안동찜닭", "육개장", "설렁탕", "추어탕", "알탕", "동태찌개", "청국장", "김치볶음밥", "오징어볶음", "낙지볶음", "부대찌개", "소갈비찜", "돼지갈비찜", "아귀찜", "해물찜", "돼지불백", "순대국", "뼈해장국", "콩나물국밥", "닭곰탕", "피순대", "평양냉면", "들기름 막국수", "통닭", "수육국밥", "돌솥비빔밥", "간장게장", "양념게장", "전복죽", "꼬막비빔밥", "매운탕", "곱창전골", "대창전골", "순대볶음"],
        japanese: ["초밥", "라멘", "돈까스", "우동", "야끼소바", "오코노미야끼", "텐동", "가츠동", "규동", "사케동", "장어덮밥", "소바", "스키야키", "샤브샤브", "야키토리", "타코야끼", "모밀", "나베", "함박스테이크", "카레라이스", "된장라면", "마제소바", "오야코동", "부타동", "히츠마부시", "몬자야키", "가라아게", "고로케", "메밀소바", "나가사키 짬뽕"],
        chinese: ["짜장면", "짬뽕", "탕수육", "마라탕", "양꼬치", "꿔바로우", "마파두부", "유린기", "깐풍기", "고추잡채", "동파육", "어향가지", "토마토계란볶음", "울면", "기스면", "중국냉면", "마라샹궈", "훠궈", "볶음밥", "잡채밥", "우육면", "탄탄면", "지삼선", "난자완스", "라조기", "해파리냉채", "멘보샤", "크림새우", "누룽지탕", "유산슬"],
        asian: ["쌀국수", "팟타이", "나시고랭", "분짜", "반미", "똠얌꿍", "월남쌈", "푸팟퐁커리", "카오팟", "쏨땀", "반세오", "껌승", "미고랭", "락사", "사테", "그린 커리", "레드 커리", "파인애플 볶음밥", "모닝글로리 볶음", "얌운센", "탄두리 치킨", "치킨 마크니", "팔락 파니르", "사모사", "난", "달프라이"],
        european: ["파스타", "피자", "리조또", "라자냐", "뇨끼", "봉골레 파스타", "까르보나라", "알리오 올리오", "로제 파스타", "토마토 스파게티", "필라프", "그라탕", "빠에야", "감바스 알 아히요", "하몽", "또르띠야 에스파뇰라", "피쉬 앤 칩스", "잠봉뵈르", "슈니첼", "굴라쉬", "수블라키"],
        american: ["스테이크", "햄버거", "클럽 샌드위치", "에그 베네딕트", "프렌치 토스트", "수비드 목살 스테이크", "대파 크림치즈 베이글", "브리스킷", "바베큐 플래터", "미트볼 스파게티", "오믈렛", "샥슈카", "타코", "부리또", "퀘사디아", "엔칠라다", "나초", "파히타", "칠리 콘 카르네", "과카몰리", "치미창가"],
        latin_american: ["세비체", "로모 살타도", "아사도", "엠파나다", "페이조아다", "슈하스코", "아레파", "반데하 파이사"],
        middle_eastern: ["케밥", "후무스", "팔라펠", "타불레", "샥슈카", "피타 브레드", "무사카", "코프타"],
        dessert: ["케이크", "마카롱", "아이스크림", "빙수", "와플", "크로플", "허니브레드", "타르트", "스콘", "쿠키", "도넛", "에그타르트", "푸딩", "티라미수", "다쿠아즈", "망고 빙수", "소금빵", "맘모스빵", "슈크림빵", "단팥빵", "카스테라", "붕어빵", "호떡", "약과", "개성주악", "탕후루", "꽈배기", "핫도그", "떡볶이", "순대", "튀김", "어묵", "군고구마", "군밤", "뻥튀기", "달고나", "츄러스"]
    };
    ...
    function generateMenuBoard() {
        const categoryMap = {
            korean: '한식', japanese: '일식', chinese: '중식', asian: '아시안', 
            european: '유러피안', american: '아메리칸', latin_american: '남미', 
            middle_eastern: '중동', dessert: '디저트/간식 🍰'
        };
