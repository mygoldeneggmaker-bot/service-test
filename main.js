...
document.addEventListener('DOMContentLoaded', () => {
    const menu = {
        ...
        western: ["파스타", "피자", "스테이크", "햄버거", "리조또", "샐러드", "클럽 샌드위치", "감바스 알 아히요", "라자냐", "뇨끼", "에그 베네딕트", "프렌치 토스트", "빠네 파스타", "봉골레 파스타", "까르보나라", "알리오 올리오", "로제 파스타", "토마토 스파게티", "필라프", "그라탕", "해장파스타", "수비드 목살 스테이크", "대파 크림치즈 베이글", "브리스킷", "바베큐 플래터", "미트볼 스파게티", "피쉬 앤 칩스", "잠봉뵈르", "포크 밸리", "오믈렛", "샥슈카"],
        southeast_asian: ["쌀국수", "팟타이", "나시고랭", "분짜", "반미", "똠얌꿍", "월남쌈", "푸팟퐁커리", "카오팟", "쏨땀", "반세오", "껌승", "미고랭", "락사", "사테", "그린 커리", "레드 커리", "파인애플 볶음밥", "모닝글로리 볶음", "얌운센"],
        mexican: ["타코", "부리또", "퀘사디아", "엔칠라다", "나초", "파히타", "토스타다", "타말레", "칠리 콘 카르네", "과카몰리", "치미창가", "멕시칸 라이스", "엘로테", "코울슬로", "세비체"],
        dessert: ["케이크", "마카롱", "아이스크림", "빙수", "와플", "크로플", "허니브레드", "타르트", "스콘", "쿠키", "도넛", "에그타르트", "푸딩", "티라미수", "다쿠아즈", "망고 빙수", "소금빵", "맘모스빵", "슈크림빵", "단팥빵", "카스테라", "붕어빵", "호떡", "약과", "개성주악", "탕후루", "꽈배기", "핫도그", "떡볶이", "순대", "튀김", "어묵", "군고구마", "군밤", "뻥튀기", "달고나"]
    };
    ...
    function generateMenuBoard() {
        const categoryMap = {
            ...
            southeast_asian: '동남아', mexican: '멕시칸', dessert: '디저트/간식 🍰'
        };
